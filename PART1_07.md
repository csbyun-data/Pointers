...
* 배열 INDEX를 통해서든 포인터를 통해서든 동일한 방식으로 요소에 접근할 수 있습니다.
...
> (arr = ptr; 주소, 재할당 불가), 배열 이름 자체가 lvalue가 될 수 없음
...
```
예제 6: 2차원 배열과 배열의 이름을 이용한 요소, 값에 접근
```c
#include <stdio.h>
